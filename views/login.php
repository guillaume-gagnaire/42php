            ...
            <div class="row">
                <div class="small-12 medium-9 medium-push-3 column text-left small-only-text-center">
                    <div class="right">
                        ...
                        <a href="<?= Argv::createUrl('socialauth').'?service=google'.(isset($_GET['redirect']) ? '&redirect='.urlencode($_GET['redirect']) : '') ?>"><i class="fi-social-google-plus" style="font-size: 36px; margin-left: 20px"></i></a>
                    </div>
